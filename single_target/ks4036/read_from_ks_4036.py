...
uart_address = "DF:C4:94:6F:5D:2B"

# Micro:bit UART receive-from-device characteristic
UART_RX_UUID = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"

# UART_RX_UUID = "e95d9775-251d-470a-a062-fa1922dfa9a8"
# UART_RX_UUID = "e95db84c-251d-470a-a062-fa1922dfa9a8"
...
async def main():
    ...
    async with BleakClient(device) as client:
        ...
        for service in client.services:
            ...
            for gatt_characteristic in service.characteristics:
                print(
                    f"    {gatt_characteristic.uuid} "
                    f"({', '.join(gatt_characteristic.properties)})"
                )
